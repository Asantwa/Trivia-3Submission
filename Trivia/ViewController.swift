...
//  Trivia
//
//  Created by Asa Smith on 3/13/24.
//
import UIKit
...
class ViewController: UIViewController {
    ...
    let questions: [Question] = [
        Question(questionNumber: "Question 1",
                 subject: "Comics",
                 questionText: "What series is Batman in ?",
                 answers: ["Marvel", "ComicCon", "DC", "VidCon"],
                 correctAnswerIndex: 2),

        Question(questionNumber: "Question 2",
                 subject: "Astronomy",
                 questionText: "Which galaxy are we in?",
                 answers: ["Earth", "MilkyWay", "Snickers", "Hershey"],
